...
const perguntas = [
  ...
  {
    pergunta: "Qual é o tipo do pokemon Bulbasaur?",
    respostas: [
  ...
  {
    pergunta: "Qual pokemon o Ash sempre carrega com ele?",
    respostas: [
      { opcao: "Pikachu", correto: true },
  ...
  {
    pergunta: "Qual pokemon evolui para Charizard?",
    respostas: [
  ...
  {
    pergunta: "Quem é o rival clássico do Ash na primeira temporada?",
    respostas: [
